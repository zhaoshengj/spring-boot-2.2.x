...
[[production-ready-endpoints-custom-com.zsj.springboot.controller]]
...
----
<1> A com.zsj.springboot.controller class to enable timings on every request handler in the com.zsj.springboot.controller.
